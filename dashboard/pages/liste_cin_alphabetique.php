         ...
         <div class="col-md-8 col-md-offset-2">
                <div class="box box-primary">
                    <div class="box-header with-border">
                          <h3 class="box-title">Liste CIN par Alphabétique</h3>
                    </div>
                     <div class="box-body">
                        <div class="box-tools">
                            <div class="input-group">
                              <input name="search" id="cin" class="form-control pull-right" placeholder="Une partie du CIN" type="text"/>
                              <div class="input-group-btn">
                                    <button class="btn btn-default" type="button" onclick="rechercher_fichier_likeCIN();"><i class="fa fa-search"></i></button>
                              </div>
                            </div>
                          </div>
                    </div>
